...
const hotspotDefinitions = [
  ...
  { id: 'engine', text: '\u0414\u0432\u0438\u0433\u0430\u0442\u0435\u043b\u044c', dataKey: 'Engine', position: [-4.5, -1, 12] }
];
...
const hotspotDescriptionMap = {
  ...
  '\u0414\u0432\u0438\u0433\u0430\u0442\u0435\u043b\u044c':
    '\u0423\u0437\u0435\u043b \u0438\u0441\u043f\u044b\u0442\u044b\u0432\u0430\u0435\u0442 \u0442\u0435\u043f\u043b\u043e\u0432\u044b\u0435 \u0438 \u0445\u0438\u043c\u0438\u0447\u0435\u0441\u043a\u0438\u0435 \u043d\u0430\u0433\u0440\u0443\u0437\u043a\u0438, \u0447\u0442\u043e \u0443\u0441\u043a\u043e\u0440\u044f\u0435\u0442 \u0440\u0430\u0437\u0440\u0443\u0448\u0435\u043d\u0438\u0435 \u0437\u0430\u0449\u0438\u0442\u043d\u043e\u0433\u043e \u043f\u043e\u043a\u0440\u044b\u0442\u0438\u044f.',
  '\u0413\u0440\u0435\u0431\u043d\u043e\u0439 \u0432\u0438\u043d\u0442':
...
function CameraRig({ focusTarget }) {
  ...
  useFrame(({ camera }) => {
    if (!targetVector || !controlsRef.current) {
      return;
    }
    ...
    <div className="app-shell">
      <div className="model-toolbar">
        ...
        <div className="toolbar-meta">
          ...
          <span>\u041a\u0430\u0434\u0440\u043e\u0432 \u0432 \u0442\u0435\u043a\u0441\u0442\u0443\u0440\u0435: {textureMeta?.sourceCount || 0}</span>
        </div>
      </div>
      ...
      {selectedHotspot && (
        <aside className="photo-sidebar open">
          <div className="photo-sidebar__header">
            ...
            <button className="photo-sidebar__close" onClick={() => setSelectedHotspot(null)}>
              \u0417\u0430\u043a\u0440\u044b\u0442\u044c
            </button>
          </div>
